...
<%@ page language="java" import="java.util.*,com.manufacturer.dao.*" pageEncoding="UTF-8"%>
<%
 			...
 			<%
 				for(Manufacturer u:users){
 			 					out.println("<tr>");
 			 						...
 			 						out.println("<td><a href=\"deleteManufacturerServlet?ID="+u.getID()+"\">删除</a></td>");
 			 						out.println("<td><a href=\"queryManufacturerByIdServlet?ID="+u.getID()+"\">更新</a></td>");
 			 					out.println("</tr>");
 			 				}
 			%>
 		</table>
